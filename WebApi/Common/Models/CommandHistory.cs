...
namespace PnIotPoc.WebApi.Common.Models
{
    public class CommandHistory
    {
        ...
        /// </summary>
        /// <param name="parameters">The parameters to set on the history. Must be either a JArray, JObject or a <see cref="Dictionary{TKey,TValue}"/> instance.</param>
        ...
        {
            return Parameters == null ? string.Empty : Parameters.ToString();
        }
    }
}
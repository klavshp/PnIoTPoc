...
namespace PnIotPoc.WebApi.Infrastructure.Repository
{
    ...
    public class AlertsRepository : IAlertsRepository
    {
        ...
        public AlertsRepository(IConfigurationProvider configProvider, IBlobStorageClientFactory blobStorageClientFactory)
        {
            ...
            _blobStorageManager = blobStorageClientFactory.CreateClient(alertsContainerConnectionString, alertsStoreContainerName);
            deviceAlertsDataPrefix = configProvider.GetConfigurationSettingValue("DeviceAlertsDataPrefix");
        }
